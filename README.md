# bga-brass-userstyle
Userstyle for Brass on BGA to tweak the UI to your needs.
...
## Install & Usage
Open [bga-brass.user.styl](https://github.com/yzemaze/bga-brass-userstyle/raw/main/bga-brass.user.styl) and hit the Stylus’ install button.
...
It’s of no use for Pittsburgh (as of 09/2026) due to implementation differences.

If you’d like to see specific tweaks [suggest them](https://github.com/yzemaze/bga-brass-userstyle/issues).